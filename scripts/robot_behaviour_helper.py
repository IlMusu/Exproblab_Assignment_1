...
class RobotBehaviourHelper(object):
    ...
    def __init__(self, armor_client):
        ...
        self.battery_level_low = 10
        rospy.Subscriber('/battery_level', UInt8, self._on_battery_level_change)
    ...
    def _on_battery_level_change(self, msg):
    ...
    def is_battery_low(self):
        self._battery_level_mutex.acquire()
        is_battery_low = self._battery_level <= self.battery_level_low
        self._battery_level_mutex.release()
